...
## 2026-05-06 - Empty Query Validation
**Learning:** Users might accidentally submit an empty form, causing the agent to run without context and potentially waste resources or return confusing errors.
