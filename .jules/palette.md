...
## 2024-05-24 - User-Friendly Model Selection
**Learning:** Displaying raw technical model IDs in Streamlit selectbox widgets degrades user experience by exposing backend implementation details.
**Action:** Use a mapping dictionary with the format_func parameter to provide user-friendly display names while maintaining the underlying technical backend functionality.
