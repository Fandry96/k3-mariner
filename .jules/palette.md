...
## 2024-08-10 - Dynamic Form Button State
**Learning:** Disabling a form submit button dynamically based on external inputs prevents invalid submissions and allows contextual guidance via tooltips.
**Action:** Use disabled and help parameters on st.form_submit_button dependent on required inputs outside the form.
