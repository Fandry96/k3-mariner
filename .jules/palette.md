...
## 2024-05-23 - Disabled State Tooltips
**Learning:** Disabling an interactive element (like a submit button) without explanation can cause user confusion.
**Action:** When disabling interactive elements in Streamlit, always provide a `help` parameter with an accessible tooltip explaining why the action is unavailable.
