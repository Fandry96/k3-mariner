...
## 2024-05-23 - Empty Query Validation
**Learning:** Users submitting empty forms triggers useless processing and can break downstream components if validation is missing. Inline warnings (`st.warning`) provide the clearest, most immediate feedback.
**Action:** Always validate required text inputs in forms and use inline warnings before proceeding with processing.
