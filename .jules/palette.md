...
## 2024-07-28 - Preventing Invalid Form Submissions
**Learning:** Users can click a form submit button even when required external state is missing, leading to an abrupt error message.
**Action:** Dynamically disable the `st.form_submit_button` based on the state of required inputs outside the form, and provide a clear `help` tooltip explaining why the button is disabled.
