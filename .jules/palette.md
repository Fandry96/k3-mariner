...
## 2024-05-27 - Empty Form Input Validation
**Learning:** Users can accidentally submit empty queries, resulting in wasted API calls or confusing empty states from the agent.
**Action:** Always validate required text inputs in Streamlit forms before processing, using inline warnings (`st.warning`) for clear feedback.
