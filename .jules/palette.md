...
## 2024-03-30 - User-friendly Streamlit Inputs
**Learning:** Raw model IDs in select boxes and unclickable help text URLs increase cognitive load and abandonment during setup.
**Action:** Use Streamlit's `format_func` to provide friendly display names for select options, and use markdown links in tooltips combined with conditional `st.caption` to provide clear, actionable setup steps.
