...
## 2026-09-10 - Streamlit Cache Serialization Overhead
**Learning:** Streamlit's `@st.cache_data` uses pickling under the hood. Caching complex objects like lists of nested dictionaries (e.g., API responses) incurs significant serialization and deserialization overhead on every cache hit compared to caching simple strings.
