...
## 2025-03-01 - DDGS Connection Pooling
...
**Action:** Always reuse a persistent `DDGS()` instance (e.g., via `@st.cache_resource` in Streamlit) to preserve connection pooling.
