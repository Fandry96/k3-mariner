...
## 2026-08-30 - Instance-Level Caching Pattern
**Learning:** Applying @functools.lru_cache to an instance method (e.g., def method(self)) uses self as part of the cache key. This causes a memory leak by preventing garbage collection of the instance, and raises a TypeError if the class inherits from an unhashable type.
