...
## 2025-03-01 - Persistent DuckDuckGo Search Client
...
**Action:** Always reuse a persistent `DDGS()` instance (e.g., via `@st.cache_resource` in Streamlit) rather than `with DDGS() as ddgs:`.
