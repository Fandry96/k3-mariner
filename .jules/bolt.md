...
## 2024-06-19 - Caching Agent Tool Outputs
**Learning:** Agent tool outputs can cause repeated network calls leading to slowdowns and rate limits, and caching them without limits can cause memory bloat.
**Action:** Implement bounded LRU-style eviction caching for tool outputs, intentionally skipping exception/error states so transient failures aren't cached.
