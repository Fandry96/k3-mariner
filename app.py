...
def perform_search(query: str):
    ...
    with DDGS() as ddgs:
        ...
        # ⚡ Bolt: Format complex dictionary responses into a single string inside the cached function
        # to reduce pickling/unpickling CPU and memory overhead on cache hits.
        return "\n".join(
            [
