...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        if query in self._cache:
            # ⚡ Bolt: Cache hit, skipping execution
        ...
        try:
            ...
            # ⚡ Bolt: Store in bounded dictionary cache to prevent memory leaks from @functools.lru_cache and bypass Streamlit's API overhead
