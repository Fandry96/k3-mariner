...
with st.form(key="mission_form", border=False):
    ...
    submit_button = st.form_submit_button("EXECUTE", type="primary", disabled=not api_key, help="Please provide an API key to execute a mission" if not api_key else None)
