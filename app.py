...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        # ⚡ Bolt: Cache search results at the agent tool level to prevent redundant network calls
        ...
        try:
            ...
            # ⚡ Bolt: Store in cache with eviction logic to prevent unbounded memory growth
