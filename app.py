...
def perform_search(query: str):
    ...
    with DDGS() as ddgs:
        ...
        # ⚡ Bolt: Format response before caching to store flat string instead of list of dicts.
        # This eliminates expensive pickling serialization/deserialization overhead on cache hits.
        if not results:
