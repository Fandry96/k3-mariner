...
def get_ddgs_client():
    """
    ⚡ Bolt: Reuses a persistent DDGS instance to prevent destroying the HTTP connection pool.
    This avoids redundant DNS, TCP, and TLS handshakes for un-cached queries.
    """
    return DDGS()
