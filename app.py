...
def perform_search(query: str) -> str:
    ...
    with DDGS() as ddgs:
        ...
        # ⚡ Bolt: Format the response string before caching to avoid pickle serialization
        # overhead of complex nested dictionary lists, improving cache retrieve/store speed.
        if not results:
