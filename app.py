...
def get_ddgs_client():
    """Persistent DuckDuckGo client to reuse HTTP connection pool."""
    return DDGS()
...
def perform_search(query: str):
    ...
    # ⚡ Bolt: Persistent DDGS() instance avoids connection pool destruction
    # and DNS/TLS handshake overhead per search (~600ms savings).
