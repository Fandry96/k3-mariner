...
@st.cache_resource
def get_ddgs_client():
    """Returns a persistent DuckDuckGo search client to reuse connection pool."""
    return DDGS()
...
def perform_search(query: str):
    ...
    # ⚡ Bolt: Reusing a persistent DDGS instance avoids DNS/TCP/TLS handshake
    # overhead for un-cached searches, significantly improving network performance.
