...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        # ⚡ Bolt: Avoid redundant queries. Time savings: ~500ms per hit
        ...
        try:
            ...
            # to reduce peak memory usage during large string concatenations.
            formatted = "\n".join(
                (
            ...
            # ⚡ Bolt: Bounded cache to avoid memory leaks
