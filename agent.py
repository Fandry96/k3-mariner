...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Cache search results to prevent redundant network calls and save time/tokens.
        ...
        try:
            ...
            # Assign computed results to a local variable before updating the cache
            # Cache the successful result with LRU-style eviction (bounded size = 50)
            ...
            # Intentional skip: Do not cache transient failures so the agent can recover on subsequent retries
