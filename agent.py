...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Initialize LRU cache to prevent redundant network calls
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Return cached result if available to save network latency
        ...
        try:
            ...
            # ⚡ Bolt: Cache formatted results and enforce LRU size bound
