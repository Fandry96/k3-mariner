...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Cache to prevent redundant identical network queries
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        try:
            ...
            # ⚡ Bolt: Update cache with new results
            self._cache[query] = result_str
            # Enforce bounds limit (50 items max)
