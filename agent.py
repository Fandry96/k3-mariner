...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Check local LRU cache to avoid redundant network calls
        ...
        try:
            ...
            if not results:
                ...
                # ⚡ Bolt: Cache empty results to avoid retrying failed queries
            ...
            # ⚡ Bolt: Add to cache and enforce bound limit of 50
            ...
            # ⚡ Bolt: Do not cache exception errors to allow retries
