...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: instance-level dictionary to cache agent tool outputs
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: LRU cache check for performance
        ...
        try:
            ...
            # ⚡ Bolt: Update cache and enforce bounded size limit using LRU-style eviction
