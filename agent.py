...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Instance-level dictionary cache to avoid lru_cache memory leak
        # with unhashable Pydantic BaseModels while preserving TCP/TLS reuse
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: O(1) cache lookup for O(N) network call reduction
        ...
        try:
            ...
            # ⚡ Bolt: Cache valid responses (including empty) but bypass on error
