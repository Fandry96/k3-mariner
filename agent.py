...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Check cache to prevent duplicate network calls
        ...
        try:
            ...
            if not results:
                computed_result = "No results found."
            else:
            ...
            # ⚡ Bolt: Cache successful responses and enforce size limit
            self._cache[query] = computed_result
