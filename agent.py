...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Add instance-level LRU cache to prevent redundant network calls
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Check LRU Cache (pop and re-insert for recency)
        ...
        try:
            ...
            # ⚡ Bolt: Update cache and enforce bounded eviction
