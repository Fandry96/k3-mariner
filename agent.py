...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Initialize bounded cache to prevent redundant network calls
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Return cached result if available to save network time
        ...
        try:
            ...
            # ⚡ Bolt: Cache successful results with LRU-style bounded size
