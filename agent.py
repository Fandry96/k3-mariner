...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        ...
        if query in self._cache:
            # ⚡ Bolt: Move accessed key to the end to maintain LRU (Least Recently Used) order
        ...
        try:
            ...
            # ⚡ Bolt: Implement LRU-style caching to avoid redundant network calls and rate limits
