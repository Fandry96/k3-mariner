...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Initialize bounded instance-level cache to prevent redundant search requests
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Return cached result if query has been searched previously
        ...
        try:
            ...
            # ⚡ Bolt: Cache formatted results and enforce bounds to prevent unbounded memory growth
