...
class MarinerSearchTool(Tool):
    ...
    def __init__(self):
        ...
        # ⚡ Bolt: Instance-level LRU cache to prevent redundant searches
        self._cache = {}
    ...
    def forward(self, query: str) -> str:
        ...
        try:
            ...
            # ⚡ Bolt: Assign computed results to a local variable before updating the cache, enforcing bounds, and returning it
            self._cache[query] = final_result
