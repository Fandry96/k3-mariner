...
class MarinerSearchTool(Tool):
    ...
    def forward(self, query: str) -> str:
        ...
        # ⚡ Bolt: Check local LRU cache to prevent duplicate network calls for identical queries
        ...
        try:
            ...
            # ⚡ Bolt: Cache successful results (including empty states) with a bounded size of 50
